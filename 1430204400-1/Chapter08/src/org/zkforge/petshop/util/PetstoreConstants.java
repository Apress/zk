...
public class PetstoreConstants {
    ...
    public static final String PETSTORE_IMAGE_DIRECTORY=System.getProperty("com.sun.aas.instanceRoot") + 
                                                            "/lib/petstore";
    public static final String PETSTORE_BASE_LOGGER="org.zkforge.petshop";
    public static final String PETSTORE_BASE_LOG_STRINGS="org.zkforge.petshop.util.LogStrings";
